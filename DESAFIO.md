...
- Receba pedidos via webhook.
- Valide e enfileire para processamento assíncrono.
- Enriqueça os dados do pedido consultando um serviço externo.
- Utilize filas para processamento e mecanismos de retry em caso de falhas.
- Demonstre boas práticas de código e arquitetura.
- Utilizar NestJS.
